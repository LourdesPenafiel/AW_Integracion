...
namespace AW_PROYECTO.Negocio
{
    public class Ng_ClsPreguntas
    {
        ...
        public int crearPreguntas(Cm_ClsPreguntas materias)
        {
            ...
            return dt_preguntas.crearPreguntas(materias.Pregunta, materias.Opcion1, materias.Opcion2, materias.Opcion3, materias.Respuesta, materias.Calificacion, materias.Id_materia, materias.Id_usuario, materias.Id_pregunta);                                                 
        }
